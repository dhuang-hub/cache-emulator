...
#   python "${SRCDIR}cache-sim.py" -n "$n" >> "${RESDIR}associativity_analysis.txt"
# done
...
#   python "${SRCDIR}cache-sim.py" -b "$b" >> "${RESDIR}memory_block_analysis.txt"
# done
...
#   python "${SRCDIR}cache-sim.py" -c "$c" >> "${RESDIR}cache_size_analysis.txt"
# done
...
#       python "${SRCDIR}cache-sim.py" -n "$n" -d "$d" -a "$a" -f "$f" >> "${RESDIR}mxm_analysis.txt"
#     done
#   done
# done
...
#     python "${SRCDIR}cache-sim.py" -a "$a" -d "$d" -r "$r" >> "${RESDIR}replacement_analysis.txt"
#   done
# done
